...
import com.onthi.laixe.onthigiaypheplaixe.activity.OnTapActivity;
 ...
 */
public class ScreenSlideOnTapDeFragment extends Fragment implements View.OnClickListener {
    ...
    public ScreenSlideOnTapDeFragment() {
...
//        radioGroup = group.findViewById(R.id.radGroup);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        OnTapActivity slideActivity = (OnTapActivity) getActivity();
...
//        }
    ...
    public static ScreenSlideOnTapDeFragment create(int pageNumber, int checkanswer) {
        ScreenSlideOnTapDeFragment fragment = new ScreenSlideOnTapDeFragment();
