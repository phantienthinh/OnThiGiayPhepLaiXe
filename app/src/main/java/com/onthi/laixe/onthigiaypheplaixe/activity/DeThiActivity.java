...
//        getSupportActionBar().setTitle("Bộ Đề");
        ...
        arrayList.add(new DeThi("Đề Số 10"));
        arrayList.add(new DeThi("Đề Số 11"));
        arrayList.add(new DeThi("Đề Số 12"));
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        switch (i){
            ...
            case 8:
                ...
                break;
            case 9:
                Intent intent9 = new Intent(this, ScreenSlideActivity.class);
                intent9.putExtra(KEY_INTENT,i);
                startActivity(intent9);
                overridePendingTransition(R.anim.anim_start, R.anim.anim_back);
                break;
            case 10:
                Intent intent10 = new Intent(this, ScreenSlideActivity.class);
                intent10.putExtra(KEY_INTENT,i);
                startActivity(intent10);
                overridePendingTransition(R.anim.anim_start, R.anim.anim_back);
                break;
            case 11:
                Intent intent11 = new Intent(this, ScreenSlideActivity.class);
                intent11.putExtra(KEY_INTENT,i);
                startActivity(intent11);
                overridePendingTransition(R.anim.anim_start, R.anim.anim_back);
                break;
            case 12:
                Intent intent12 = new Intent(this, ScreenSlideActivity.class);
                intent12.putExtra(KEY_INTENT,i);
