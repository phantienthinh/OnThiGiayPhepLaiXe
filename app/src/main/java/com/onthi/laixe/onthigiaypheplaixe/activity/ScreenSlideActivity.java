...
public class ScreenSlideActivity extends FragmentActivity implements View.OnClickListener, AdapterView.OnItemClickListener, DialogInterface.OnCancelListener {
    /**
...
//        animator.start();
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (SharedPreferencesManager.getButtonEnd(ScreenSlideActivity.this) == true) {
