...
import com.onthi.laixe.onthigiaypheplaixe.activity.NgauNhienActivity;
 ...
 */
public class ScreenSlideNgauNhienDeFragment extends Fragment implements View.OnClickListener {
    ...
    public ScreenSlideNgauNhienDeFragment() {
...
//        radioGroup = group.findViewById(R.id.radGroup);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NgauNhienActivity slideActivity = (NgauNhienActivity) getActivity();
...
//            Toast.makeText(context, arr_ques.get(mPageNumber).getKetqua().toString(), Toast.LENGTH_LONG).show();
    ...
    public static ScreenSlideNgauNhienDeFragment create(int pageNumber, int checkanswer) {
        ScreenSlideNgauNhienDeFragment fragment = new ScreenSlideNgauNhienDeFragment();
