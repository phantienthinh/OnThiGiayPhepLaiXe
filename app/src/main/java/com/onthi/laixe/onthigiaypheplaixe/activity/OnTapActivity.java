...
import com.onthi.laixe.onthigiaypheplaixe.fragments.ScreenSlideOnTapDeFragment;
...
public class OnTapActivity extends FragmentActivity implements View.OnClickListener, AdapterView.OnItemClickListener, DialogInterface.OnCancelListener {
    /**
...
//        tv_check.setOnClickListener(this);
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (SharedPreferencesManager.getButtonEnd(OnTapActivity.this)==true){
...
//        iv_hourGlass.startAnimation(animation);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return ScreenSlideOnTapDeFragment.create(position,checkAnswer);
        }
...
//        };
        ...
        timer = new CountDownTimerPausable(timeDeThi,1000) {
            ...
            @Override
            public void onFinish() {
                Toast.makeText(OnTapActivity.this, "hết giò", Toast.LENGTH_SHORT).show();
                iv_hourGlass.clearAnimation();
