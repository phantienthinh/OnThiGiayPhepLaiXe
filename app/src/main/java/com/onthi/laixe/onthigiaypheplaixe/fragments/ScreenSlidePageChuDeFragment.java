...
import com.onthi.laixe.onthigiaypheplaixe.activity.ScreenSlideChuDeActivity;
 ...
 */
public class ScreenSlidePageChuDeFragment extends Fragment implements View.OnClickListener {
    ...
    public ScreenSlidePageChuDeFragment() {
...
//        radioGroup = group.findViewById(R.id.radGroup);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ScreenSlideChuDeActivity slideActivity = (ScreenSlideChuDeActivity) getActivity();
...
//        }
    ...
    public static ScreenSlidePageChuDeFragment create(int pageNumber, int checkanswer) {
        ScreenSlidePageChuDeFragment fragment = new ScreenSlidePageChuDeFragment();
