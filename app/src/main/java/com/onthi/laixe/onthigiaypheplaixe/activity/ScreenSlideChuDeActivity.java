...
import com.onthi.laixe.onthigiaypheplaixe.fragments.ScreenSlidePageChuDeFragment;
...
public class ScreenSlideChuDeActivity extends FragmentActivity implements View.OnClickListener, AdapterView.OnItemClickListener, DialogInterface.OnCancelListener {
    /**
...
//        animator.start();
        ...
        arr_questions = questionController.getQuestionChuDe(i);
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (SharedPreferencesManager.getButtonEnd(ScreenSlideChuDeActivity.this)==true){
...
//                finish();
                Intent intent = new Intent(this,ShowKQActivity.class);
...
//        iv_hourGlass.startAnimation(animation);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return ScreenSlidePageChuDeFragment.create(position,checkAnswer);
        }
...
//        };
        ...
        timer = new CountDownTimerPausable(timeDeThi,1000) {
            ...
            @Override
            public void onFinish() {
                Toast.makeText(ScreenSlideChuDeActivity.this, "hết giò", Toast.LENGTH_SHORT).show();
                iv_hourGlass.clearAnimation();
